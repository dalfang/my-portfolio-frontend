...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/16flK4Qs4xqhNwNU76ZwV41DToP7QA9XQ/view?usp=drive_link", // Set to empty to hide the button
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡  Design and implement backend systems to support dynamic web applications"),
    emoji(
